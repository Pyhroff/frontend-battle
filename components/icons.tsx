/* ════════════════════════════════════════════════════════════════
   Provided SVG Pack (asset_package.zip → /SVGs) — Heroicons set.
   Re-authored as React components using `currentColor` so each
   inherits the surrounding text/accent color. Every icon in the
   pack is used somewhere on the page (asset-compliance requirement).
   ════════════════════════════════════════════════════════════════ */
...
export const ArrowPath = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth}
...
export const ArrowTrendingUp = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth}
...
export const ChartPie = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
...
export const ChevronLeft = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth}
...
export const ChevronUp = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth}
...
export const Cog8Tooth = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth}>
...
export const Link = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth}
...
export const XMark = ({ size = 24, className, strokeWidth = 1.5 }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth}
...
export const ChevronUpSolid = ({ size = 24, className }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
...
export const Cube = ({ size = 24, className }: IconProps) => (
...
export const LinkSolid = ({ size = 24, className }: IconProps) => (
  <svg {...base(size)} className={className} aria-hidden="true">
    <path fill="currentColor" fillRule="evenodd" clipRule="evenodd"
